"""Subsystem client_sdk implementation for feature-flag-rollout-service."""
...
class ClientSdkEngine:
    def __init__(self, config: Optional[ClientSdkConfig] = None):
        self.config = config or ClientSdkConfig()
    ...
    def process_request(self, ctx: ClientSdkContext) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError(f'Execution failure in client_sdk: {ex}') from ex

"""Subsystem evaluator implementation for feature-flag-rollout-service."""
...
class EvaluatorEngine:
    ...
    def process_request(self, ctx: EvaluatorContext) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError(f'Execution failure in evaluator: {ex}') from ex
